...
{
    public class FillClassifiedGridControlDataController : ApiController
    {
        ...
        public IEnumerable<GridData> Post(BookingDetail objbookingDetail)
        {
            ...
            try
            {
                ...
                foreach (DataRow dr in objdt.Rows)
                {
                    ...
                    objgriddata.AgencyName = Convert.ToString(dr["AgencyName"]);
                   // objgriddata.CasualClientName = Convert.ToString(dr["CasualClientName"]);
                    ...
                    objgriddata.ReasonName = Convert.ToString(dr["RejectedReason"]);
                    objgriddata.RejectedNote = Convert.ToString(dr["RejectedNote"]);
                    objgriddata.AdText = Convert.ToString(dr["AdText"]);
                    objgriddata.AdTexts = Convert.ToString(dr["AdTexts"]);
